...
import useUpdateUserDetails from "../../../screens/users/hook/useUpdateUserDetails";

interface form {
  closeModel: () => void;
}

const EditForm: FC<form> = ({ closeModel },ref) => {
  const role = {
    Tester: 1,
    Lead: 2,
    Manager: 3,
  ...
  const [update, loading] = useUpdateUserDetails();
